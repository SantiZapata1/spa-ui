    ...
    return (
        <div className=" mb-5 flex flex-col items-center justify-center bg-white shadow-lg rounded-lg md:w-6/10 p-4 mt-5">
            ...
            >
                ...
                <InputText require type="text" placeholder="Servicio" register={register} setValue={setValue} campo="" nombre="servicio" errors={errors.servicio} />
                ...
                <button type="submit" className="p-3 mt-2 bg-green-900 w-full hover:bg-green-700 text-white font-bold rounded-lg shadow-lg">
                    Enviar
                </button>
            </form>
